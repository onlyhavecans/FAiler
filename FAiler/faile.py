...
class FAile():
    ...
    def __init__(self, faFile):
        ...
        """
        self.directory = os.path.dirname(os.path.abspath(faFile))
    ...
    def clean_reupload(self):
        ...
        >>> f2.clean_reupload()
        >>> "{0.userName} - {0.submissionName}.{0.fileType}".format(f2)
        'furball - shim_bday2013.jpg'
        """
        check = re.match(self._FILE_RE, "{0.submissionName}.{0.fileType}".format(self))
